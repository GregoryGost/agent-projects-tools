...
description: "Use for E2E testing of non-browser TypeScript Node.js services: HTTP APIs, CLIs, workers, queues, real dependencies, Testcontainers/Docker services, Supertest/fetch, Jest orchestration, setup/teardown, and E2E review."
---
...
- `references/patterns-and-review.md` for E2E design patterns and review prompts.
...
5. Confirm project-declared E2E command, setup, teardown, dependency policy, and artifact policy.
...
- Prefer readiness checks and health probes over fixed sleeps.
...
- [ ] Setup and teardown clean up app instances, containers, connections, env, ports, queues, and temp files.
