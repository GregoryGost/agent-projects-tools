...
6. Check browser support and fallback requirements for modern features, especially container queries, nesting, `:has()`, subgrid, viewport units, color functions, form-control styling, scrollbars, and animation/interaction media queries.
