...
Vue unit and component test dependencies such as `vitest`, `@vue/test-utils`, `jsdom`, `happy-dom`, and `@pinia/testing` belong to the Vue frontend testing baseline, not to this code quality profile.
