...
## Внешние приложения, плагины и системы

В этом разделе перечисляются только внешние приложения, плагины и системы, для которых в репозитории есть правила, скилы или специальные ограничения.

Для уже добавленных Obsidian-related материалов используются или упоминаются:

- **Obsidian** — приложение, с которым связаны Obsidian-related правила и скилы.
- **Semantic Notes Vault MCP / Obsidian MCP** — MCP-доступ к Obsidian vault.
- **Context7 MCP** — источник документации, упоминаемый в Obsidian-правилах.
- **Obsidian Tasks plugin** — плагин Obsidian, учитываемый в правилах для taskbook.
- **Obsidian Templater** — опциональный плагин Obsidian, учитываемый только когда он включён, явно запрошен или уже используется в заметках и шаблонах.
- **Dataview** и **Bases** — опциональные возможности Obsidian, используемые только когда они установлены и нужны задаче.

Новые внешние приложения, плагины и системы должны быть описаны рядом с правилом или скилом, который от них зависит.
...
3. **Явные внешние зависимости** — требования к внешним приложениям, плагинам, MCP-серверам и системам нужно описывать рядом с правилом или скилом.
