...
6. **Краткий routing description** — поле `description` в frontmatter скилла должно кратко и в начале формулировать условия его активации и отличительные ключевые слова. Полный перечень возможностей, workflow и ограничений должен оставаться в теле `SKILL.md`, а не перегружать routing description.
